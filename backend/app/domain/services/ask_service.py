...
def _is_conversational(q: str) -> bool:
    ...
    if len(q) > 80:
        return False
    # treat very short sentences (<= 8 words) as conversational
...
def ask_question(question=None, shortcut=None):
    ...
    # 🔥 STEP 0: If it's a short conversational message (hi, hello, etc.),
    # route directly to Ollama chat — skip Neo4j/Cypher entirely.
